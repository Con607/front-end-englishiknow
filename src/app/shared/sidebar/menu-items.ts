...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    extralink: false,
    submenu: [
      { path: '/pages/courses', title: 'All courses', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
      { path: '/pages/courses', title: 'My Courses', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
      { path: '/pages/courses', title: 'Wish List', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] }
    ]
  }
  // {
  //   path: '',
